...
def generate_vcpkg_install_options(build_dir, args):
    ...
    if args.use_gemmini:
        vcpkg_install_options.append("--x-feature=gemmini-ep")
    if args.use_cuda:
...
def generate_build_tree(
    ...
    if gemmini_root and os.path.exists(gemmini_root):
        cmake_args += ["-DGEMMINI_ROOT=" + gemmini_root]
    ...
    if args.use_gemmini:
        cmake_args += ["-Donnxruntime_USE_GEMMINI=ON"]
...
def main():
    ...
    gemmini_root = args.gemmini_root
