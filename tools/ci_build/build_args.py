...
def add_execution_provider_args(parser: argparse.ArgumentParser) -> None:
    ...
    # --- GEMMINI ---
    gemmini_group = parser.add_argument_group("GEMMINI Execution Provider")
    gemmini_group.add_argument("--use_gemmini", action="store_true", help="Enable GEMMINI EP.")
    gemmini_group.add_argument("--gemmini_root", help="Path to GEMMINI Library root directory.")
